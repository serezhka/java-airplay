...
import static com.github.serezhka.airplay.protocol.fairplay.SapTables.*;

public class SapKeySchedule {

    private final FairPlayDigest modifiedMD5 = new FairPlayDigest();
