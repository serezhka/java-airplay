package com.github.serezhka.airplay.protocol.fairplay;
...
public class SapTables {
    ...
    static {
        try {
            table_s1 = readBytes(SapTables.class.getResource("/table_s1"));
            table_s2 = readBytes(SapTables.class.getResource("/table_s2"));
            table_s3 = readBytes(SapTables.class.getResource("/table_s3"));
            table_s4 = readBytes(SapTables.class.getResource("/table_s4"));
            table_s5 = readInts(SapTables.class.getResource("/table_s5"));
            table_s6 = readInts(SapTables.class.getResource("/table_s6"));
            table_s7 = readInts(SapTables.class.getResource("/table_s7"));
            table_s8 = readInts(SapTables.class.getResource("/table_s8"));
            table_s9 = readInts(SapTables.class.getResource("/table_s9"));
            table_s10 = readBytes(SapTables.class.getResource("/table_s10"));
        } catch (Exception e) {
    ...
    /**
     * Files.newBufferedReader(Paths.get(SapTables.class.getClassLoader().getResource("table_s5").toURI()))
